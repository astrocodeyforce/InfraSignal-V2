...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:atom="http://www.w3.org/2005/Atom">
    ...
    <xsl:template match="/">
        ...
        <!-- Navigation Bar -->
        <th style="[% td_style %] padding: 0;">
            <div style="background: #ee6e00; padding: 8px 20px; font-size: 14px; line-height: 20px;">
                <a href="[% c.cobrand.base_url %]/" style="color: #ffffff; text-decoration: none; font-weight: bold; margin-right: 16px;">&#x2190; Home</a>
                <a href="[% c.cobrand.base_url %]/alert" style="color: #ffffff; text-decoration: none; margin-right: 16px;">Local alerts</a>
                <a href="[% c.cobrand.base_url %]/reports" style="color: #ffffff; text-decoration: none; margin-right: 16px;">All reports</a>
                <a href="[% c.cobrand.base_url %]/report/new" style="color: #ffffff; text-decoration: none; margin-right: 16px;">Report a problem</a>
                <a href="[% c.cobrand.base_url %]/faq" style="color: #ffffff; text-decoration: none;">Help</a>
            </div>
        </th>
